...
# Constants
CHROME_DRIVER_PATH = "C:/Users/juan.tamara/Desktop/NetSuite/driver/chromedriver.exe"
LOG_FILE_PATH = "C:/Users/juan.tamara/Desktop/NetSuite/log.txt"
...
driver.find_element(By.ID, 'uif51').send_keys(google)
driver.find_element(By.ID, "uif65").click()
driver.find_element(By.ID, "uif69").click()
...
if day > 31 or month > 12:
    ...
    dates = driver.find_element(By.XPATH,
                                '/html/body/div[1]/div[2]/form[1]/div[2]/div/div[2]/div[2]/span[2]/span/input').click()
    driver.find_element(By.XPATH,
                        '/html/body/div[1]/div[2]/form[1]/div[2]/div/div[2]/div[2]/span[2]/span/input').send_keys(
        f'{day}/{month}/2023')
    driver.find_element(By.XPATH,
                        '/html/body/div[1]/div[2]/form[1]/div[2]/div/div[2]/div[5]/span[2]/span/input').click()
    driver.find_element(By.XPATH,
                        '/html/body/div[1]/div[2]/form[1]/div[2]/div/div[2]/div[5]/span[2]/span/input').send_keys(
        f'{day}/{month}/2023')
    driver.find_element(By.XPATH,
                        '/html/body/div[1]/div[2]/form[1]/div[2]/div/div[2]/div[5]/span[2]/span/input').send_keys(
        Keys.TAB)
    ...
    for page in range(total_pages):
        ...
        for rows in range(2, rows_quantity):
            try:
                # Get cell value
                invoice = driver.find_element(By.XPATH,
                                              '/html/body/div[1]/div[2]/form[2]/div[2]/table/tbody/tr[' + str(
                                                  rows) + ']/td[14]/a')
                ...
                error1 = driver.find_element(By.XPATH,
                                             '/html/body/div[1]/div[2]/form[2]/div[2]/table/tbody/tr[' + str(
                                                 rows) + ']/td[3]/a')
            ...
            try:
                ...
                # Write a log if is not possible to find an element
                error2 = driver.find_element(By.XPATH,
                                             '/html/body/div[1]/div[2]/form[2]/div[2]/table/tbody/tr[' + str(
                                                 rows) + ']/td[3]/a')
